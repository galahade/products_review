...
package local_project.getorders_0_5;
...
public class GetOrders implements TalendJob {
	...
	public static class row10Struct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_GetOrders = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_GetOrders = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_GetOrders.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_GetOrders.length == 0) {
						commonByteArray_LOCAL_PROJECT_GetOrders = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_GetOrders = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_GetOrders, 0,
						length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_GetOrders,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_GetOrders) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = GetOrders.class.getClassLoader()
					.getResourceAsStream(
							"local_project/getorders_0_5/contexts/"
...
/************************************************************************************************
 * 382895 characters generated by Talend Open Studio for Data Integration on the
 * 29 October 2015 17:39:58 CST
 ************************************************************************************************/
