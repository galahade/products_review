...
package yema.updateorderstatus_0_5;
...
public class UpdateOrderStatus implements TalendJob {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_YEMA_UpdateOrderStatus = new byte[0];
		static byte[] commonByteArray_YEMA_UpdateOrderStatus = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_YEMA_UpdateOrderStatus.length) {
					if (length < 1024
							&& commonByteArray_YEMA_UpdateOrderStatus.length == 0) {
						commonByteArray_YEMA_UpdateOrderStatus = new byte[1024];
					} else {
						commonByteArray_YEMA_UpdateOrderStatus = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_YEMA_UpdateOrderStatus, 0, length);
				strReturn = new String(commonByteArray_YEMA_UpdateOrderStatus,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_YEMA_UpdateOrderStatus) {
		...
		try {
			...
			java.io.InputStream inContext = UpdateOrderStatus.class
					.getClassLoader().getResourceAsStream(
							"yema/updateorderstatus_0_5/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 591337 characters generated by Talend Open Studio for Data Integration on the
 * 19 October 2015 16:43:06 BST
 ************************************************************************************************/
