...
public class SendEmail implements TalendJob {
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_YEMA_SendEmail = new byte[0];
		static byte[] commonByteArray_YEMA_SendEmail = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_YEMA_SendEmail.length) {
					if (length < 1024
							&& commonByteArray_YEMA_SendEmail.length == 0) {
						commonByteArray_YEMA_SendEmail = new byte[1024];
					} else {
						commonByteArray_YEMA_SendEmail = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_YEMA_SendEmail, 0, length);
				strReturn = new String(commonByteArray_YEMA_SendEmail, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_YEMA_SendEmail) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SendEmail.class.getClassLoader()
					.getResourceAsStream(
							"yema/sendemail_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 91526 characters generated by Talend Open Studio for Data Integration on the
 * 19 October 2015 16:41:39 BST
 ************************************************************************************************/
